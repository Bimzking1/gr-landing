// GARUNNA runner-profiling engine v2.
...
const S = {
  jersey: {
    ...
    'oversized-tee': [['Mood Booster Runner',2],['Playlist Merchant',1.3],['Reward Runner',1.3]],
    'compression-shirt': [['Early Bird',2],['Pace Demon',1.3]],
    'finisher-event-shirt': [['Gear Acquisition Syndrome',1.3],['Medal Hunter',3]],
    'random-free-event-tee': [['Coffee Run Enjoyer',1.3],['Reluctant Runner',2],['Start\'n\'Stop Runner',1]],
  },
  shoes: {
    'daily-trainer': [['Health Runner',2],['Silent Assassin',1.3]],
    'carbon-race-shoes': [['Ambitious Late Bloomer',1],['Gear Acquisition Syndrome',1.3],['PB Hunter',1.3]],
    'trail-shoes': [['Anywhere Runner',3]],
    'fashion-sneakers': [['Strava CEO',1.3],['Trendy Runner',3]],
    'cheapest-shoes': [['Coffee Run Enjoyer',1.3],['Reluctant Runner',2],['Reward Runner',1.3]],
  ...
  gear: {
    ...
    'apple-watch': [['Health Runner',2],['Strava CEO',1.3]],
    'strava-on-phone': [['Mood Booster Runner',2],['Playlist Merchant',1.3],['Reward Runner',1.3],['Strava CEO',1.3]],
    'no-tracking': [['Coffee Run Enjoyer',1.3],['Reluctant Runner',3],['Silent Assassin',1.3],['Start\'n\'Stop Runner',1]],
  },
  time: {
    'before-sunrise': [['Early Bird',4],['PB Hunter',1.3],['Pace Demon',1.3]],
    'morning': [['Gear Acquisition Syndrome',1.3],['Health Runner',2],['Reward Runner',1.3]],
    'afternoon': [['Coffee Run Enjoyer',1.3],['Strava CEO',1.3],['Trendy Runner',1]],
    'evening': [['Mood Booster Runner',3],['Playlist Merchant',1.3]],
    'midnight': [['Silent Assassin',1.3],['Solo Runner',2]],
    'whenever-i-can': [['Anywhere Runner',4],['Start\'n\'Stop Runner',1]],
  },
  companion: {
    'alone': [['PB Hunter',1.3],['Pace Demon',1.3],['Silent Assassin',1.3],['Solo Runner',4]],
    'running-club': [['Club Runner',4],['Playlist Merchant',1.3]],
    'one-friend': [['Mood Booster Runner',2],['Playlist Merchant',1.3],['Reward Runner',1.3]],
    'large-group': [['Club Runner',2],['Gear Acquisition Syndrome',1.3],['Strava CEO',1.3]],
    'my-dog': [['Coffee Run Enjoyer',1.3],['Mood Booster Runner',2]],
    'whoever-invites-me': [['Anywhere Runner',2],['Start\'n\'Stop Runner',1]],
  },
  goal: {
    'lose-weight': [['Weight Loss Runner',4]],
    'be-healthier': [['Health Runner',4]],
    'finish-my-first-5k': [['Ambitious Late Bloomer',2],['PB Hunter',1.3]],
    'complete-a-marathon': [['Long Runner',2],['Pace Demon',1.3],['Silent Assassin',1.3]],
    'collect-medals': [['Gear Acquisition Syndrome',1.3],['Medal Hunter',4]],
    'just-have-fun': [['Coffee Run Enjoyer',1.3],['Mood Booster Runner',4],['Playlist Merchant',1.3],['Reward Runner',1.3],['Start\'n\'Stop Runner',1]],
  },
};
